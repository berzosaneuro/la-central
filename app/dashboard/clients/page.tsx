    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <h1 style={{ margin: '10px 0 0 0', fontSize: '28px' }}>CLIENTES</h1>
        </div>
          ...
          <div style={{
            ...
            {clients.map(client => (
              <div key={client.id} style={{
                ...
                <h3 style={{ margin: '0 0 10px 0', color: '#b4c8dc' }}>{client.name}</h3>
                <p style={{ color: '#7a8a9a', fontSize: '13px', margin: '5px 0' }}>Email: {client.email}</p>
                {client.phone && <p style={{ color: '#7a8a9a', fontSize: '13px', margin: '5px 0' }}>Tel: {client.phone}</p>}
                {client.company && <p style={{ color: '#7a8a9a', fontSize: '13px', margin: '5px 0' }}>Empresa: {client.company}</p>}
                <p style={{
